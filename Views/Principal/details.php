                ...
                <div class="card job-detail overflow-hidden">
                    ...
                    <div class="card-body p-4">
                        <div>
                            <div class="row">
                                <div class="col-md-8">
                                    <h5 class="mb-1">Ingeniero Civil</h5>
                                    <ul class="list-inline text-muted mb-0">
                                        <li class="list-inline-item">
                                            <i class="mdi mdi-account"></i> 2 Vacantes
                                        </li>
                            ...
                            <div class="row g-2">
                                <div class="col-lg-3">
                                    <div class="border rounded-start p-3">
                                        <p class="text-muted mb-0 fs-13">Experiencia</p>
                                        <p class="fw-medium fs-15 mb-0">Minimo 2 años</p>
                                    </div>
                                </div>
                                <div class="col-lg-3">
